describe('Kiểm tra tình trạng voucher', function() {
    ...
    it('Kiểm tra điều kiện không hợp lệ', () => {
        cy.request({
            method: 'POST',
            url: 'api/v1/user/voucher/check-buy',
    ...
    it('Kiểm tra điều kiện hợp lệ', () => {
        cy.request({
            ...
            failOnStatusCode: false,
            body: {
                "transactionId": "26683f23-c431-41b3-bf79-f1c006279027|28888b28-5846-46e2-843b-abaabc3ca00d"
            },
            headers: {
                Authorization: `Bearer ${accessToken}`,
                user_id: userId,
            ...
            expect(body.message).to.eq('Kiểm tra thành công !');
